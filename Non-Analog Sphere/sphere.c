...
divided into a determined number of layers, where the inner ones\n\
are filed with a fissionable material (fuel), and the outer\n\
ones are filed with the a non-fissionable material (moderator).\n\
Statistical weight avaliation and Russian Roulette are played,\n\
so the simulations are non-analog.\n\n\
