...
/*
    write_data:     Depending on the chosen option, either writes the absolute or relative 
                    quantities estimated in the given stream. The in the first line after 
                    the collumn labels the mean of the quantities is written, and in the 
                    second line, the standard deviation. If it is a new file, writes 
                    the collumns labels.
*/
